...
image::cover.jpg[Cover image]

== Building and Deploying
This is a Gradle multi-module project.

It requires JDK 11, but works with 12 as well.

The *-practice projects, have tests and pieces left unimplemented so building the full project using:
----
gradle build
----
will fail.
