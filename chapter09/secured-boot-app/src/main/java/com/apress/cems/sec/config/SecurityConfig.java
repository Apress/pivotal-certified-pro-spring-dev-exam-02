...
@ComponentScan("com.apress.cems.sec")
class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests()
                .mvcMatchers("/persons/**").hasRole("USER")
                ...
                .and()
                //.requestMatcher(EndpointRequest.toAnyEndpoint()).authorizeRequests().anyRequest().hasRole("ADMIN")
                //.and()
                .httpBasic()
                .and()
                .logout();
